...
const dnsCakeTestOptions: TestOptions = {
  upgradeTo: "RoleableV2",
  runReapRewardExtra: true,
}

testStrategy("Dns Cake Strategy - Deploy", deployDnsStrategy, dnsCakeTestOptions, [
  //testAum,
...
async function deployDnsStrategy() {
  return await deployStrategy("DnsCake")
}

async function upgradeDnsStrategy() {
  return upgradeStrategy("DnsCake")
}
