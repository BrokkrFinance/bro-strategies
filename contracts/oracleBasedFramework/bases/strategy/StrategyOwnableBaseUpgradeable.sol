...
abstract contract StrategyOwnableBaseUpgradeable is OwnableUpgradeable, StrategyBaseUpgradeable {
    uint256[8] private __gap;

    // solhint-disable-next-line
    function __StrategyOwnableBaseUpgradeable_init(StrategyArgs calldata strategyArgs) internal onlyInitializing {
        __Ownable_init();
    ...
    function takePerformanceFee(NameValuePair[] calldata params) public virtual onlyOwner {
    ...
    function takeManagementFee(NameValuePair[] calldata params) public virtual onlyOwner {
    ...
    function setSwapService(SwapServiceProvider provider, address router) public virtual onlyOwner {
