...
contract PercentageAllocationAnyToken is UUPSUpgradeable, PortfolioRoleablePausableAnyTokenBaseUpgradeable {
    ...
    // solhint-disable-next-line const-name-snakecase
    string public constant humanReadableName = "Percentage allocation any token portfolio";
    // solhint-disable-next-line const-name-snakecase
    ...
    function initialize(PortfolioArgs calldata portfolioArgs, address newSwapLibAddress) external initializer {
        __UUPSUpgradeable_init();
        __PortfolioRoleablePausableAnyTokenBaseUpgradeable_init(portfolioArgs, newSwapLibAddress);
    }
