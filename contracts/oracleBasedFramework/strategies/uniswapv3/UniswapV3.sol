...
import { RangeDesc, LiquidityIncrease, LiquidityDecrease } from "./Common.sol";
...
contract UniswapV3 is UUPSUpgradeable, StrategyRoleablePausableBaseUpgradeable {
    ...
    struct InitializeParams {
        ...
        LiquidityIncrease[] liquidityIncreases;
    ...
    function initialize(
        ...
        for (uint256 i = 0; i < rangeDescsLength; ++i) {
            strategyStorage.rangeDescs.push(
                RangeDesc(
                    initializeParams.rangeDescs[rangeDescsLength].sqrtRatioAX96,
                    initializeParams.rangeDescs[rangeDescsLength].sqrtRatioBX96
                )
            );
        }
