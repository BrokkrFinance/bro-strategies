...
contract RoleableV2 is UUPSUpgradeable, StrategyRoleablePausableBaseUpgradeable {
    // solhint-disable-next-line const-name-snakecase
    string public constant trackingName = "brokkr.test_strategy.roleable_strategy_v2.0.0";
    // solhint-disable-next-line const-name-snakecase
