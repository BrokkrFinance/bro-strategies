...
contract GmxOracle is OwnableUpgradeable, UUPSUpgradeable, IPriceOracle {
    ...
    function getPrice(
        ...
        uint256 tokenPriceInUsd = vendorFeed.getPrice(address(token), shouldMaximise, includeAmmPrice, false);
        uint256 usdcPriceInUsd = vendorFeed.getPrice(address(baseToken), shouldMaximise, includeAmmPrice, false);
