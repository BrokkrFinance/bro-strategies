...
import "../../strategies/dnsVectorStrategy/DnsVectorStrategyStorageLib.sol";
import "../../strategies/dnsVectorStrategy/DnsVectorStrategyAumLib.sol";
import "../../strategies/dnsVectorStrategy/DnsVectorStrategyInvestmentLib.sol";
...
contract DnsVectorStrategyV2 is
    UUPSUpgradeable,
    StrategyRoleablePausableBaseUpgradeable
{
    ...
    string public constant trackingName =
        "brokkr.dns_vector_strategy.dns_vector_strategy_v2.0.0";
    // solhint-disable-next-line const-name-snakecase
